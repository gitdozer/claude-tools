...
!`git diff --cached -M -U2 --no-color --no-ext-diff --diff-algorithm=minimal -- . ':(exclude)*.lock' ':(exclude)*-lock.json' ':(exclude)*.lockb' ':(exclude)*.min.js' ':(exclude)*.min.css' ':(exclude)*.map' ':(exclude)*.snap' ':(exclude)*.ipynb' ':(exclude)*.csv' ':(exclude)*.tsv' ':(exclude)*.parquet' ':(exclude)*.xlsx' ':(exclude)*.pdf' ':(exclude)*.png' ':(exclude)*.jpg' ':(exclude)*.gif' ':(exclude)*.pkl' ':(exclude)*.h5' ':(exclude)*.zip' ':(exclude)dist/*' ':(exclude)*/dist/*' ':(exclude)build/*' ':(exclude)node_modules/*' | wc -c`

DIFF (2 lines of context; lock files, build output, notebooks, data files and images are listed above but not diffed here):
!`git diff --cached -M -U2 --no-color --no-ext-diff --diff-algorithm=minimal -- . ':(exclude)*.lock' ':(exclude)*-lock.json' ':(exclude)*.lockb' ':(exclude)*.min.js' ':(exclude)*.min.css' ':(exclude)*.map' ':(exclude)*.snap' ':(exclude)*.ipynb' ':(exclude)*.csv' ':(exclude)*.tsv' ':(exclude)*.parquet' ':(exclude)*.xlsx' ':(exclude)*.pdf' ':(exclude)*.png' ':(exclude)*.jpg' ':(exclude)*.gif' ':(exclude)*.pkl' ':(exclude)*.h5' ':(exclude)*.zip' ':(exclude)dist/*' ':(exclude)*/dist/*' ':(exclude)build/*' ':(exclude)node_modules/*' | head -c 12000`
